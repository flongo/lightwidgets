...
Aria.classDefinition({
    $classpath : "test.atplugins.lightWidgets.datepicker.DatePickerTestTen",
    ...
    $prototype : {
        ...
        _afterCalendarType : function () {
            ...
            var formattedDate = aria.utils.Date.format(aria.utils.Date.interpret("-30"), this.getDatePattern());
            this._checkValue(formattedDate);
            this._checkDataModel(aria.utils.Date.interpret("-30"));
