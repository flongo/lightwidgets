...
Aria.classDefinition({
    $classpath : "test.atplugins.lightWidgets.autocomplete.AutocompleteBindTestThree",
    ...
    $prototype : {
        ...
        _afterFirstType : function () {
            ...
            this.checkTextValue("abcdefghi");
            this.checkDataModel(null);
            this._checkChangeLogCount(0);
            this.blur();
            this._checkChangeLogCount(1);
            this._testDropDownOpen(false);
            this.checkTextValue("abcdefghi");
            this.checkDataModel("abcdefghi");
            this.end();
        }
    }
});
